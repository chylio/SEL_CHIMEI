          ...
          <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="flex flex-nowrap gap-2 justify-center lg:justify-start">
              {[
                ...
                <span key={a.label} className="flex-shrink-0 flex items-center gap-1 bg-white/80 border border-amber-100 text-warm-text text-sm px-2.5 py-1.5 rounded-full shadow-sm font-medium">
